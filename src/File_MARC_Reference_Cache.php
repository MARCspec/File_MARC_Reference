...
class File_MARC_Reference_Cache implements ArrayAccess
{
    ...
    * @param boolean|null                              $value Validation result for a subspec
    * 
    ...
    * @param boolean|null            $value   Validation result true or false
    * 
    * @return boolean|null      If subspec was already validated return true or false.
    ...
    */ 
     ...
     * @param boolean|null                            $value The data
     */ 
